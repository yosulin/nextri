...
const ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './logo-marca.svg?v=2.93',
  './favicon.ico',
  './icon.svg',
  './rivales/delta.png?v=2.93',
  './rivales/circuit.png?v=2.93',
  './rivales/vector.png?v=2.93',
  './rivales/chaos.png?v=2.93',
  './rivales/phantom.png?v=2.93',
  './rivales/lumina.png?v=2.93',
  './icon-192.png',
  './icon-512.png',
  './src/game/random.js?v=2.93',
  './src/game/geometry.js?v=2.93',
  './src/game/rules.js?v=2.93',
  './src/game/board.js?v=2.93',
  './src/game/board-quality.js?v=2.93',
  './src/game/engine.js?v=2.93',
  './src/game/state.js?v=2.93',
  './src/i18n/i18n.js?v=2.93',
  './src/i18n/locales/es.js?v=2.93',
  './src/i18n/locales/en.js?v=2.93',
  './src/i18n/locales/fr.js?v=2.93',
  './src/ui/radar.js?v=2.93',
  './src/ai/invitados.js?v=2.93',
  './src/ai/levels.js?v=2.93',
  './src/ai/ai.js?v=2.93',
  './src/stats/repository.js?v=2.93',
  './src/stats/aggregates.js?v=2.93',
  './src/stats/stats.js?v=2.93',
  './src/progression/guest-progress.js?v=2.93',
  './src/platform/storage.js?v=2.93'
];
