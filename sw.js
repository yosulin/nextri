...
const ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './logo-marca.svg?v=3.17',
  './favicon.ico',
  './icon.svg',
  './rivales/delta.png?v=3.17',
  './rivales/circuit.png?v=3.17',
  './rivales/vector.png?v=3.17',
  './rivales/chaos.png?v=3.17',
  './rivales/phantom.png?v=3.17',
  './rivales/lumina.png?v=3.17',
  './icon-192.png',
  './icon-512.png',
  './src/game/random.js?v=3.17',
  './src/game/geometry.js?v=3.17',
  './src/game/rules.js?v=3.17',
  './src/game/board.js?v=3.17',
  './src/game/board-quality.js?v=3.17',
  './src/game/engine.js?v=3.17',
  './src/game/state.js?v=3.17',
  './src/i18n/i18n.js?v=3.17',
  './src/i18n/locales/es.js?v=3.17',
  './src/i18n/locales/en.js?v=3.17',
  './src/i18n/locales/fr.js?v=3.17',
  './src/ui/radar.js?v=3.17',
  './src/ai/invitados.js?v=3.17',
  './src/ai/levels.js?v=3.17',
  './src/ai/ai.js?v=3.17',
  './src/stats/repository.js?v=3.17',
  './src/stats/aggregates.js?v=3.17',
  './src/stats/stats.js?v=3.17',
  './src/progression/guest-progress.js?v=3.17',
  './src/platform/storage.js?v=3.17'
];
