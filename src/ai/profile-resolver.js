...
import { AI_PROFILES, RIVALES } from './levels.js?v=3.15';
import { resolveCapacityAdjustedProfile } from './capacity.js?v=3.15';
import { phantomAIProfile } from '../progression/player-model.js?v=3.15';
