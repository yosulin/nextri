...
import { AI_PROFILES, RIVALES } from './levels.js?v=3.14';
import { resolveCapacityAdjustedProfile } from './capacity.js?v=3.14';
import { phantomAIProfile } from '../progression/player-model.js?v=3.14';
