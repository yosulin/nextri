...
import { AI_PROFILES, RIVALES } from './levels.js?v=3.17';
import { resolveCapacityAdjustedProfile } from './capacity.js?v=3.17';
import { phantomAIProfile } from '../progression/player-model.js?v=3.17';
