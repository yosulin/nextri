...
import { DIST_EPS, dist, segmentPassesOverCircle } from './geometry.js?v=2.83';
import { evaluateBoardQuality, BOARD_QUALITY_TARGET } from './board-quality.js?v=2.83';
import { rngNextFrom } from './random.js?v=2.83';
