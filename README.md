...
cruzarse ni pasar por encima de otros círculos.

- **En solitario** contra tres rivales con carácter propio: **Delta**
  (espontáneo), **Circuit** (estratega) y **Vector** (analista).
